        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <StaggerChildrens className="mx-auto max-w-[800px] text-center">
                <MotionDiv
                ...
                >
                  <h1>
                    Transform Your{" "}
                    <span className="text-primary">Digital Presence</span> with
                ...
                >
                  <h2>
                    Build beautiful, functional websites that captivate your
                    audience and grow your business.
                  </h2>
                </MotionDiv>
                <MotionDiv variants={slideUpWithFade} className="">
                  <MotionDiv
                    variants={staggerChildrens}
